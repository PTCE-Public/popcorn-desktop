<div class="about-container">
    ...
    <div class="content">
        ...
        <div class="title-version">
            ...
            <% if(App.git) { %>
            - <small><i><%= App.git.branch %> (<a class="links" href="<%= App.Config.links.git %>/popcorn-desktop/commit/<%= App.git.commit %>"><%= App.git.commit.slice(0,8) %></a>)</i></small>
            <% } %>
        </div>

        <div class="title-issue">
            <a href="<%= App.Config.links.git %>" data-toggle="tooltip" data-placement="top" title="<%= App.Config.links.git %>" class='links'><%= i18n.__("Report an issue") %></a>
        </div>
        ...
        <div class="icons_social">
            <a href="<%= App.Config.links.site %>" data-toggle="tooltip" data-placement="top" title="<%= App.Config.links.site %>" class='links site_icon'></span></a>
            <a href="<%= App.Config.links.discuss %>" data-toggle="tooltip" data-placement="top" title="<%= App.Config.links.discuss %>" class='links forum_icon'></span></a>
            <a href="<%= App.Config.links.git %>" data-toggle="tooltip" data-placement="top" title="<%= App.Config.links.git %>" class='links stash_icon'></span></a>
        </div>
