<ul class="nav nav-hor left">
    <li class="source active showMovies providerinfo" data-toggle="tooltip" data-placement="top" title="Movie API"><%= i18n.__("Movies") %></li>
    <li class="source showShows providerinfo" data-toggle="tooltip" data-placement="top" title="TV API"><%= i18n.__("TV Series") %></li>
